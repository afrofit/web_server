...
var getUserChaptersActivity = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.params, userId = _a.userId, storyId = _a.storyId, playedStoryId = _a.playedStoryId;
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
                playedChaptersRepo = data_source_1.AppDataSource.getMongoRepository(PlayedChapter_1.PlayedChapter);
                return [4 /*yield*/, playedChaptersRepo.find({
                        where: { userId: userId, storyId: storyId },
                    })];
            case 2:
                playedChapters = _b.sent();
                ...
                return [2 /*return*/, res.status(status_codes_1.STATUS_CODES.CREATED).send({ chapters: mappedChapters_1 })];
            case 3:
                error_1 = _b.sent();
...
exports.default = getUserChaptersActivity;
//# sourceMappingURL=get-user-chapters-activity.js.map