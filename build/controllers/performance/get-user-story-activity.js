...
var getUserStoryActivity = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, userId, storyId, playedStoryRepo, playedStory, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.params, userId = _a.userId, storyId = _a.storyId;
                _b.label = 1;
            case 1:
                _b.trys.push([1, 5, , 6]);
                playedStoryRepo = data_source_1.AppDataSource.getMongoRepository(PlayedStory_1.PlayedStory);
                return [4 /*yield*/, playedStoryRepo.findOne({
                        where: { userId: userId, storyId: storyId },
                    })];
            case 2:
                playedStory = _b.sent();
                if (!!playedStory) return [3 /*break*/, 4];
                playedStory = new PlayedStory_1.PlayedStory();
            ...
            case 3:
                _b.sent();
                _b.label = 4;
            case 4: return [2 /*return*/, res.status(status_codes_1.STATUS_CODES.CREATED).send({ playedStory: playedStory })];
            case 5:
                error_1 = _b.sent();
...
exports.default = getUserStoryActivity;
//# sourceMappingURL=get-user-story-activity.js.map