...
var getUserPerformanceData = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, performanceRepo, existingPerformance, trimmedPerformance, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, performanceRepo.findOne({
                        where: { userId: userId },
                    })];
            case 2:
                existingPerformance = _a.sent();
                if (!existingPerformance)
                    return [2 /*return*/, res
                            .status(status_codes_1.STATUS_CODES.BAD_REQUEST)
                            .send("Oops! Your performance data doesn't exist.")];
                trimmedPerformance = lodash_1.default.pick(existingPerformance, [
                    "totalUserSteps",
                    "totalUserTime",
                    "daysActive",
                    "caloriesBurned",
...
exports.default = getUserPerformanceData;
//# sourceMappingURL=get-user-performance-data.js.map