...
var getAllEvent = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var eventRepo, results, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                (0, logger_1.logger)("============getAllEvent================");
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                eventRepo = data_source_1.AppDataSource.getMongoRepository(Event_1.Event);
                return [4 /*yield*/, eventRepo.find({ where: { isHide: false } })];
            case 2:
                results = _a.sent();
                return [2 /*return*/, res
...
//# sourceMappingURL=get-all-event.js.map