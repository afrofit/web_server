...
exports.createWeeklyLeaderboard = void 0;
...
var createWeeklyLeaderboard = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                leaderboardRepo = data_source_1.AppDataSource.getMongoRepository(Leaderboard_1.Leaderboard);
                _a.label = 1;
            case 1:
                _a.trys.push([1, 7, , 8]);
                return [4 /*yield*/, leaderboardRepo.find({
            ...
            case 3:
                ...
                return [4 /*yield*/, leaderboardRepo.save(newLeaderboard_1)];
            case 4:
                _a.sent();
                return [2 /*return*/, newLeaderboard_1];
            case 5:
                newLeaderboard = new Leaderboard_1.Leaderboard();
                return [4 /*yield*/, leaderboardRepo.save(newLeaderboard)];
            case 6:
                _a.sent();
                return [2 /*return*/, newLeaderboard];
            case 7:
                error_1 = _a.sent();
...
//# sourceMappingURL=create-weekly-leaderboard.js.map