...
exports.getAllShop = void 0;
var data_source_1 = require("../../data-source");
var Shop_1 = require("../../entity/Shop");
var logger_1 = require("../../logger");
var status_codes_1 = require("../../types/status-codes");
var getAllShop = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var shopRepo, results, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                (0, logger_1.logger)("============getAllShop================");
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                shopRepo = data_source_1.AppDataSource.getMongoRepository(Shop_1.Shop);
                return [4 /*yield*/, shopRepo.find({ where: { isHide: false } })];
            case 2:
                results = _a.sent();
                return [2 /*return*/, res
...
//# sourceMappingURL=get-all-shop.js.map