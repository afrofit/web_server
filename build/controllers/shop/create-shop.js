...
var createShop = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var files, _a, description, title, shopRepo, shopData, _i, files_1, file, fileType, results, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                (0, logger_1.logger)("createShop: ".concat(JSON.stringify(req.body)));
                files = req.files;
            ...
            case 1:
                ...
                return [4 /*yield*/, shopRepo.save(shopData)];
            case 2:
                results = _b.sent();
                return [2 /*return*/, res
