...
var deleteFeedback = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var feedbackId, feedbackRepo, existingFeedback, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                (0, logger_1.logger)("deleteFeedback: ".concat(JSON.stringify(req.params)));
