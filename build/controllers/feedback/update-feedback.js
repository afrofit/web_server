...
var updateFeedback = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, description, title, isHide, name, feedbackId, feedbackRepo, existingFeedback, results, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                (0, logger_1.logger)("updateFeedback: ".concat(JSON.stringify(req.body)));
                _a = req.body, description = _a.description, title = _a.title, isHide = _a.isHide, name = _a.name;
            ...
            case 2:
                ...
                if (isHide === "false")
                    existingFeedback.isHide = false;
                if (req.file) {
                    if ((0, fs_1.existsSync)("./public/".concat(existingFeedback.imageUrl)))
                        (0, fs_1.unlinkSync)("./public/".concat(existingFeedback.imageUrl));
                    existingFeedback.imageUrl = req.file.filename;
                }
                return [4 /*yield*/, feedbackRepo.save(existingFeedback)];
            case 3:
                results = _b.sent();
                return [2 /*return*/, res
...
//# sourceMappingURL=update-feedback.js.map