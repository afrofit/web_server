...
var deleteClass = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var classId, classRepo, existingClass, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                (0, logger_1.logger)("deleteClass: ".concat(JSON.stringify(req.params)));
            ...
            case 2:
                ...
                if (!existingClass)
                    return [2 /*return*/, res.status(status_codes_1.STATUS_CODES.BAD_REQUEST).send("Class does not exist")];
...
//# sourceMappingURL=delete-class.js.map