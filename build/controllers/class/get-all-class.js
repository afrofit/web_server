...
exports.getAllClass = void 0;
var data_source_1 = require("../../data-source");
var Class_1 = require("../../entity/Class");
var logger_1 = require("../../logger");
var status_codes_1 = require("../../types/status-codes");
var getAllClass = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var classRepo, results, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                (0, logger_1.logger)("============getAllClass================");
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                classRepo = data_source_1.AppDataSource.getMongoRepository(Class_1.Class);
                return [4 /*yield*/, classRepo.find({ where: { isHide: false } })];
            case 2:
                results = _a.sent();
                return [2 /*return*/, res
...
//# sourceMappingURL=get-all-class.js.map