...
var getUserSubscription = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, formattedUserId, usersRepo, existingUser, isSubscribed, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                isSubscribed = true;
                return [2 /*return*/, res.status(status_codes_1.STATUS_CODES.CREATED).send({ isSubscribed: isSubscribed })];
            case 3:
                error_1 = _a.sent();
...
exports.default = getUserSubscription;
