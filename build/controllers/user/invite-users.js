...
var inviteUsers = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, subject, text, inviteLink, mailInfo, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                (0, logger_1.logger)("inviteUsers ReqBody: ".concat(JSON.stringify(req.body)));
                _a = req.body, email = _a.email, subject = _a.subject, text = _a.text;
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
                inviteLink = "".concat(process.env.CLIENT_URL);
                (0, logger_1.logger)("inviteLink: ".concat(inviteLink));
                mailInfo = {
                    to: email,
                    subject: subject,
                    html: text,
