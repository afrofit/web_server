    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                leaderboardScoresRepo = data_source_1.AppDataSource.getMongoRepository(LeaderboardScore_1.LeaderboardScore);
                return [4 /*yield*/, (0, create_weekly_leaderboard_1.createWeeklyLeaderboard)()];
            case 3:
                activeLeaderboard = _a.sent();
                if (!activeLeaderboard)
                    return [2 /*return*/, res
                            .status(status_codes_1.STATUS_CODES.BAD_REQUEST)
                            .send("Error fetching leaderboard")];
                return [4 /*yield*/, leaderboardScoresRepo.find({
            ...
            case 5:
                ...
                return [4 /*yield*/, leaderboardScoresRepo.save(userLeaderboardScore)];
            case 6:
                _a.sent();
                _a.label = 7;
            case 7:
...
exports.default = getMarathonData;
//# sourceMappingURL=get-marathon-data.js.map