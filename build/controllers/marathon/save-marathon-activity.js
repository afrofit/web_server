...
var saveMarathonActivity = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, mockData;
    return __generator(this, function (_a) {
        ...
        try {
            return [2 /*return*/, res.status(status_codes_1.STATUS_CODES.CREATED).send({ marathon: mockData })];
        }
        catch (error) {
            console.error(error);
            return [2 /*return*/, res
...
exports.default = saveMarathonActivity;
//# sourceMappingURL=save-marathon-activity.js.map